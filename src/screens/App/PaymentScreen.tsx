...
const createStyles = (colors: ReturnType<typeof useThemeColors>) => StyleSheet.create({
  ...
  payButtonText: { color: colors.white, fontWeight: "800" },
  secondaryButton: {
    marginTop: 10,
    borderWidth: 1,
    borderColor: colors.border,
  ...
  voucherLabel: { color: colors.white, fontSize: 12, fontWeight: "700", opacity: 0.9 },
  voucherCode: { color: colors.white, fontSize: 22, fontWeight: "800" },
  errorText: {
    color: "#dc2626",
    fontSize: 14,
    marginTop: 8,
